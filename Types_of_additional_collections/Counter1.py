'''
You have access to a list of files containing the names of various files. Complete the code below to list
all file extensions present in the files list, specifying for each the number of files with that extension.
The extensions must be arranged in lexicographical order, each on a separate line, in the following format:
